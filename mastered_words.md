# Flashcard Progress Tracker

Words are added to your deck automatically each morning. Use the **Mark as Mastered** button in the app — your progress is saved automatically between sessions.

This file serves as a log of every word added to your deck, organized by date.

---

## Words by Date Added

### Initial Deck — April 23, 2026

- [ ] **Sophistry** — Clever but flawed reasoning designed to deceive *(Arguments & Reasoning)*
- [ ] **Syllogism** — A logical argument where a conclusion follows from two premises *(Arguments & Reasoning)*
- [ ] **Tautology** — Saying the same thing twice in different words; needlessly circular *(Arguments & Reasoning)*
- [ ] **Axiom** — A self-evident truth taken as a starting point *(Arguments & Reasoning)*
- [ ] **Non Sequitur** — A conclusion that doesn't follow from the evidence *(Arguments & Reasoning)*
- [ ] **Specious** — Looks valid on the surface, but isn't *(Ideas & Claims)*
- [ ] **Reductive** — Oversimplifying something complex *(Ideas & Claims)*
- [ ] **Germane** — Relevant and appropriate to the topic *(Ideas & Claims)*
- [ ] **Apocryphal** — Of doubtful authenticity; probably not true *(Ideas & Claims)*
- [ ] **Cogent** — Clear, logical, and convincing *(Ideas & Claims)*
- [ ] **Tendentious** — Slanted toward a particular viewpoint *(Bias & Perspective)*
- [ ] **Solipsistic** — Unable to consider any perspective beyond one's own *(Bias & Perspective)*
- [ ] **Parochial** — Narrow in scope; limited to a local or small-minded view *(Bias & Perspective)*
- [ ] **Epistemic** — Relating to knowledge or the degree of its validation *(Bias & Perspective)*
- [ ] **Equivocal** — Open to multiple interpretations; ambiguous *(Nuance & Complexity)*
- [ ] **Heterodox** — Contrary to established or accepted beliefs *(Nuance & Complexity)*
- [ ] **Dialectical** — Relating to the tension between opposing forces or ideas *(Nuance & Complexity)*
- [ ] **Liminal** — In between two states; on the threshold of something *(Nuance & Complexity)*

---

### April 23, 2026

- [ ] **Ad Hominem** — Attacking the person making an argument rather than the argument itself *(Arguments & Reasoning)*
- [ ] **Confirmation Bias** — The tendency to favor information that confirms one's existing beliefs *(Bias & Perspective)*
- [ ] **Ambivalent** — Having simultaneous conflicting feelings or attitudes about something *(Nuance & Complexity)*
- [ ] **Exegesis** — Critical interpretation and explanation of a text or idea *(Critical Thinking)*
- [ ] **Euphemism** — A mild or indirect word used in place of something blunt or unpleasant *(Language & Rhetoric)*

---

### April 24, 2026

- [ ] **Strawman** — Misrepresenting someone's argument to make it easier to attack *(Arguments & Reasoning)*
- [ ] **Paradigm** — A typical pattern, model, or dominant framework of thought *(Ideas & Claims)*
- [ ] **Motivated Reasoning** — Reasoning toward a desired conclusion rather than toward truth *(Bias & Perspective)*
- [ ] **Counterfactual** — Relating to what would have happened under different conditions *(Critical Thinking)*
- [ ] **Laconic** — Using very few words; brief and to the point *(Language & Rhetoric)*

---

### April 23, 2026 (Morning Run)

- [ ] **Inductive** — Reasoning from specific observations to a general conclusion *(Arguments & Reasoning)*
- [ ] **Salient** — Most noticeable, relevant, or important among a set of things *(Ideas & Claims)*
- [ ] **Cognitive Dissonance** — The discomfort of holding two conflicting beliefs simultaneously *(Bias & Perspective)*
- [ ] **Inchoate** — Just begun; not yet fully formed or clearly articulated *(Nuance & Complexity)*
- [ ] **Hermeneutics** — The theory and methodology of interpretation, especially of texts *(Critical Thinking)*

---

### April 23, 2026

- [ ] **Abductive** — Inferring the most likely explanation from incomplete evidence *(Arguments & Reasoning)*
- [ ] **Verisimilitude** — The appearance of being true or real, even if not actually so *(Ideas & Claims)*
- [ ] **Halo Effect** — Letting one positive trait color the overall perception of a person or idea *(Bias & Perspective)*
- [ ] **Provisional** — Temporary or preliminary; subject to revision as new information arrives *(Nuance & Complexity)*
- [ ] **Apophenia** — Perceiving meaningful patterns or connections in random, unrelated data *(Critical Thinking)*

---

### April 24, 2026

- [ ] **Deductive** — Reasoning from general premises to a specific, necessary conclusion *(Arguments & Reasoning)*
- [ ] **Ethnocentrism** — Judging other cultures by the standards and values of one's own *(Bias & Perspective)*
- [ ] **Contingent** — Dependent on circumstances; possible but not inevitable *(Nuance & Complexity)*
- [ ] **Epistemology** — The branch of philosophy concerned with the nature and limits of knowledge *(Critical Thinking)*
- [ ] **Circumlocution** — Using many words where fewer would suffice; roundabout expression *(Language & Rhetoric)*

---

### April 25, 2026

- [ ] **Post Hoc** — Wrongly assuming that because B follows A, A caused B *(Arguments & Reasoning)*
- [ ] **Empirical** — Based on observation and evidence rather than theory or assumption *(Ideas & Claims)*
- [ ] **Dogmatic** — Rigidly adhering to a set of beliefs without questioning or nuance *(Bias & Perspective)*
- [ ] **Systemic** — Relating to or embedded throughout a whole system, not just one part *(Nuance & Complexity)*
- [ ] **Falsifiable** — Capable of being proven false by evidence; a key criterion of science *(Critical Thinking)*

---

### April 26, 2026

- [ ] **Fallacious** — Containing a logical error or misleading reasoning *(Arguments & Reasoning)*
- [ ] **Ostensible** — Appearing to be true on the surface, but not necessarily so *(Ideas & Claims)*
- [ ] **Presentism** — Judging the past by present-day standards and values *(Bias & Perspective)*
- [ ] **Palimpsest** — Something altered but still bearing visible traces of its earlier form *(Nuance & Complexity)*
- [ ] **Socratic** — Using probing questions to expose false beliefs and reach deeper truth *(Critical Thinking)*

---

### April 27, 2026

- [ ] **Reductio ad Absurdum** — Disproving a claim by showing it leads to an absurd conclusion *(Arguments & Reasoning)*
- [ ] **Spurious** — False, misleading, or not genuine in appearance *(Ideas & Claims)*
- [ ] **Myopic** — Lacking foresight; short-sighted in perspective or thinking *(Bias & Perspective)*
- [ ] **Antithetical** — Directly opposed or contrasted; the exact opposite *(Nuance & Complexity)*
- [ ] **Falsifiable** — Capable of being proven false by evidence; a key criterion of science *(Critical Thinking)*
...
- [ ] **Apodictic** — Clearly demonstrated; necessarily true beyond dispute *(Arguments & Reasoning)*
- [ ] **Normative** — Relating to standards or norms of what ought to be, not what is *(Ideas & Claims)*
- [ ] **Relativism** — The view that truth and morality are not absolute but depend on perspective *(Bias & Perspective)*
- [ ] **Iterative** — Progressing through repeated cycles of refinement or improvement *(Nuance & Complexity)*
- [ ] **Chiasmus** — Reversing the grammatical structure of parallel phrases for stylistic effect *(Language & Rhetoric)*
...
- [ ] **Dogmatic** — Rigidly adhering to a set of beliefs without questioning or nuance *(Bias & Perspective)*
- [ ] **Systemic** — Relating to or embedded throughout a whole system, not just one part *(Nuance & Complexity)*
- [ ] **Ontological** — Relating to the nature of being, existence, or reality itself *(Critical Thinking)*

---

### May 1, 2026

- [ ] **False Dichotomy** — Presenting only two options when more alternatives exist *(Arguments & Reasoning)*
- [ ] **Substantive** — Having a firm basis in reality; meaningful and not superficial *(Ideas & Claims)*
- [ ] **Perspicacious** — Having a ready insight; shrewd and perceptive in judgment *(Bias & Perspective)*
- [ ] **Mercurial** — Subject to sudden or unpredictable changes; volatile *(Nuance & Complexity)*
- [ ] **Synecdoche** — Using a part to represent the whole, or the whole to represent a part *(Language & Rhetoric)*

---

### May 2, 2026

- [ ] **Aporia** — A state of philosophical puzzlement or an unanswerable question *(Arguments & Reasoning)*
- [ ] **Putative** — Generally accepted or supposed to be the case, often without proof *(Ideas & Claims)*
- [ ] **Sycophantic** — Fawningly complimentary; excessively agreeable to gain favor *(Bias & Perspective)*
- [ ] **Deontological** — Relating to duty-based ethics: judging actions by rules, not outcomes *(Critical Thinking)*
- [ ] **Metonymy** — Referring to something by the name of an associated concept *(Language & Rhetoric)*

---

### May 3, 2026

- [ ] **Heuristic** — A practical problem-solving approach that is useful but not guaranteed to be optimal *(Arguments & Reasoning)*
- [ ] **Taxonomy** — A systematic scheme of classification or categorization *(Ideas & Claims)*
- [ ] **Credulous** — Too ready to believe things without sufficient evidence; gullible *(Bias & Perspective)*
- [ ] **Bifurcated** — Divided or forked into two distinct branches or directions *(Nuance & Complexity)*
- [ ] **Consequentialist** — Judging the morality of actions by their outcomes and effects *(Critical Thinking)*

---

### May 4, 2026

- [ ] **Occam's Razor** — The principle that the simplest sufficient explanation is usually correct *(Arguments & Reasoning)*
- [ ] **Teleological** — Relating to or explained by purpose, design, or final goals *(Ideas & Claims)*
- [ ] **Insular** — Narrow-minded due to isolation from outside perspectives or experiences *(Bias & Perspective)*
- [ ] **Reification** — Treating an abstract concept as if it were a concrete, tangible thing *(Critical Thinking)*
- [ ] **Dysphemism** — A harsh or blunt expression used in place of a more neutral one *(Language & Rhetoric)*

---

### May 6, 2026

- [ ] **Modus Ponens** — If P implies Q, and P is true, then Q must be true *(Arguments & Reasoning)*
- [ ] **Probative** — Having the quality of proving or demonstrating something *(Ideas & Claims)*
- [ ] **Chauvinism** — Excessive belief in the superiority of one's own group over others *(Bias & Perspective)*
- [ ] **Recursive** — Defined in terms of itself; self-referential in structure or process *(Nuance & Complexity)*
- [ ] **Anaphora** — Deliberate repetition of a phrase at the start of successive clauses *(Language & Rhetoric)*

---

### May 7, 2026

- [ ] **Petitio Principii** — Assuming the conclusion within the premise; circular reasoning *(Arguments & Reasoning)*
- [ ] **Axiomatic** — Self-evidently true; accepted without requiring proof *(Ideas & Claims)*
